...
const registerUserInDB = async (name, email, password, contact, city,address,meter_id) => {
  const query =
...
const getUserDetails = async (user_id) => {
  const query = "select id,name,meter_id,email,city,role_id, address from user_details where id = ? and is_deleted = 0";
